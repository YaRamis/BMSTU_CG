...
if __name__ == "__main__":
    ...
    win.title("Лабораторная работа №10")
    win.resizable(False, False)

    style = ttk.Style(win)
    style.configure('default.TButton', font='"Segoe UI Variable" 14')
    ...
    back_box.place(x = CV_WIDE + 20, y = 5)

    add_dot_text = Label(win, text = "-----------------------------------------------------------------------------Функция-----------------------------------------------------------------------------", width = 43, font="-family {Consolas} -size 16", bg = MAIN_TEXT_COLOR, fg='#545454')
    add_dot_text.place(x = CV_WIDE + 20, y = 5)
    ...
    graph1_option.place(x = CV_WIDE + 10, y = 35)
    ...
    graph2_option.place(x = CV_WIDE + 300, y = 35)
    ...
    graph3_option.place(x = CV_WIDE + 10, y = 65)
    ...
    graph4_option.place(x = CV_WIDE + 300, y = 65)

    # Set limits for function

    back_box = Label(text = "", font="-family {Consolas} -size 16", width = 43, height = 5, bg = BOX_COLOR)
    back_box.place(x = CV_WIDE + 20, y = 95)

    figure_add_dot_text = Label(win, text = "-----------------------------------------------------------------------------Пределы-----------------------------------------------------------------------------", width = 43, font="-family {Consolas} -size 16", bg = MAIN_TEXT_COLOR, fg='#545454')
    figure_add_dot_text.place(x = CV_WIDE + 20, y = 95)

    # Axis OX

    x_limit_text = Label(text = "Ось X  -- ", font="-family {Consolas} -size 14", bg = BOX_COLOR)
    x_limit_text.place(x = CV_WIDE + 30, y = 130)

    x_from_text = Label(text = "от: ", font="-family {Consolas} -size 14", bg = BOX_COLOR)
    x_from_text.place(x = CV_WIDE + 150, y = 130)
    ...
    x_from_entry.place(x = CV_WIDE + 190, y = 130)

    x_to_text = Label(text = "до: ", font="-family {Consolas} -size 14", bg = BOX_COLOR)
    x_to_text.place(x = CV_WIDE + 295, y = 130)
    ...
    x_to_entry.place(x = CV_WIDE + 330, y = 130)

    x_step_text = Label(text = "шаг: ", font="-family {Consolas} -size 14", bg = BOX_COLOR)
    x_step_text.place(x = CV_WIDE + 430, y = 130)
    ...
    x_step_entry.place(x = CV_WIDE + 480, y = 130)
    ...
    z_limit_text.place(x = CV_WIDE + 30, y = 160)

    z_from_text = Label(text = "от: ", font="-family {Consolas} -size 14", bg = BOX_COLOR)
    z_from_text.place(x = CV_WIDE + 150, y = 160)
    ...
    z_from_entry.place(x = CV_WIDE + 190, y = 160)

    z_to_text = Label(text = "до: ", font="-family {Consolas} -size 14", bg = BOX_COLOR)
    z_to_text.place(x = CV_WIDE + 295, y = 160)
    ...
    z_to_entry.place(x = CV_WIDE + 330, y = 160)

    z_step_text = Label(text = "шаг: ", font="-family {Consolas} -size 14", bg = BOX_COLOR)
    z_step_text.place(x = CV_WIDE + 430, y = 160)
    ...
    z_step_entry.place(x = CV_WIDE + 480, y = 160)
    ...
    figure_add_dot_text = Label(win, text = "-----------------------------------------------------------------------------Вращение-----------------------------------------------------------------------------", width = 43, font="-family {Consolas} -size 16", bg = MAIN_TEXT_COLOR, fg='#545454')
    figure_add_dot_text.place(x = CV_WIDE + 20, y = 190)

    # Spin OX

    x_spin_text = Label(text = "OX: ", font="-family {Consolas} -size 14", bg = BOX_COLOR)
    x_spin_text.place(x = CV_WIDE + 120, y = 225)
    ...
    x_spin_entry.place(x = CV_WIDE + 190, y = 225)

    x_spin_btn = ttk.Button(win, text = "Повернуть", style='default.TButton', command = lambda: spin_x())
    x_spin_btn.place(x = CV_WIDE + 330, y = 220)
    ...
    y_spin_text.place(x = CV_WIDE + 120, y = 265)
    ...
    y_spin_entry.place(x = CV_WIDE + 190, y = 265)

    y_spin_btn = ttk.Button(win, text = "Повернуть", style='default.TButton', command = lambda: spin_y())
    y_spin_btn.place(x = CV_WIDE + 330, y = 260)
    ...
    z_spin_text.place(x = CV_WIDE + 120, y = 305)
    ...
    z_spin_entry.place(x = CV_WIDE + 190, y = 305)

    z_spin_btn = ttk.Button(win, text = "Повернуть", style='default.TButton', command = lambda: spin_z())
    z_spin_btn.place(x = CV_WIDE + 330, y = 300)
    ...
    back_box = Label(text = "", font="-family {Consolas} -size 16", width = 43, height = 5, bg = BOX_COLOR)
    back_box.place(x = CV_WIDE + 20, y = 340)

    figure_add_dot_text = Label(win, text = "-----------------------------------------------------------------------------Масштабировать-----------------------------------------------------------------------------", width = 43, font="-family {Consolas} -size 16", bg = MAIN_TEXT_COLOR, fg='#545454')
    figure_add_dot_text.place(x = CV_WIDE + 20, y = 340)

    # Scale k

    scale_text = Label(text = "Коэффициент k ", font="-family {Consolas} -size 14", bg = BOX_COLOR)
    scale_text.place(x = CV_WIDE + 120, y = 375)

    scale_entry = Spinbox(font="-family {Consolas} -size 14", from_ = FROM_SPIN_BOX, to=TO_SPIN_BOX, increment=STEP_SPIN_BOX, width = 7)
    # x_spin_entry = Entry(font="-family {Consolas} -size 14", width = 6)
    scale_entry.place(x = CV_WIDE + 330, y = 375)

    scale_btn = ttk.Button(win, text = "Масштабировать", style='default.TButton', command = lambda: scale_graph())
    scale_btn.place(x = CV_WIDE + 190, y = 405)
    ...
    back_box_filling.place(x = CV_WIDE + 20, y = 445)

    color_text = Label(win, text = "-----------------------------------------------------------------------------Выбрать-цвет-графика-----------------------------------------------------------------------------", width = 43, font="-family {Consolas} -size 16", bg = MAIN_TEXT_COLOR, fg='#545454')
    color_text.place(x = CV_WIDE + 20, y = 445)
    ...
    color_graph_orange.place(x = CV_WIDE + 25, y = 470)
    ...
    color_graph_red.place(x = CV_WIDE + 400, y = 470)
    ...
    color_graph_blue.place(x = CV_WIDE + 25, y = 495)
    ...
    color_graph_green.place(x = CV_WIDE + 400, y = 495)


    cut_btn = ttk.Button(win, text = "Результат", style='default.TButton', command = lambda: build_graph(new_graph = True))
    cut_btn.place(x = CV_WIDE + 20, y = 550, relheight=0.06, relwidth=0.15)

    clear_btn = ttk.Button(win, text = "Очистить экран", style='default.TButton', command = lambda: reboot_prog())
    clear_btn.place(x = CV_WIDE + 350, y = 550, relheight=0.06, relwidth=0.15)
